...
def upsert_result_csv(result, filename="Output/incremental_SM_TI,j.csv"):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        for instance_id in range(11, 12):
            ...
            command = f"./runlim/runlim -r {TIMEOUT} {sys.executable} CSE_INC_2025_SMTIJ.py {instance_id}"
